                            ...
                            <div class="col-md-6">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group has-feedback
                                        ...
                                        <input required type="text" value="{{ old('reg_number') }}" class="form-control"
                                    ...
                                    <div class="form-group has-feedback
                                        ...
                                        <input required type="text" value="{{ old('firstname') }}" class="form-control"
                                    ...
                                    <div class="form-group col-md-6 has-feedback
                                        ...
                                        <input required type="text" value="{{ old('birth_place') }}" class="form-control"
                                    ...
                                    <div class="form-group has-feedback
                                        ...
                                        <input type="tel" class="form-control" required
                                               ...
                                               data-role="tagsinput" value="{{ old('nationalities') }}">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group
                                        ...
                                        <input type="text" value="{{ old('father_job') }}" class="form-control"
                                    ...
                                    <div class="form-group
                                        ...
                                        <input type="tel" class="form-control"
                                               ...
                                               data-role="tagsinput" value="{{ old('father_phones') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group
                                        ...
                                        <input type="text" value="{{ old('mother_job') }}" class="form-control"
                                    ...
                                    <div class="form-group
                                        ...
                                        <input type="tel" class="form-control"
                                               ...
                                               data-role="tagsinput" value="{{ old('mother_phones') }}">
                                    ...
                                    <div class="form-group
                                        ...
                                        <input type="text" value="{{ old('guardian_name') }}" class="form-control"
                                    ...
                                    <div class="form-group
                                        ...
                                        <input type="tel" class="form-control"
                                               ...
                                               data-role="tagsinput" value="{{ old('guardian_phones') }}">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group
                                        ...
                                        <input type="text" value="{{ old('living_place') }}" class="form-control"
                                    ...
                                    <div class="form-group
                                        ...
                                        <input type="text" class="form-control"
                                               ...
                                               data-role="tagsinput" value="{{ old('emails') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group
                                        ...
                                        <select id = "resp_schooling" class="form-control selectpicker show-tick"
                                            ...
                                            <option value="Père et Mère">Père et Mère</option>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group
                                        ...
                                        <input type="text" value="{{ old('cned_id') }}" class="form-control"
                                    ...
                                    <div class="form-group
                                        ...
                                        <input type="text" value="{{ old('cned_password') }}" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="checkbox-inline">
                                            ...
                                            <input type="checkbox" name="gave_id_picture"
                                                   id="gave_id_picture" value="1"> Photo d'identité
