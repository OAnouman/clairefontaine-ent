            ...
            <div class="row">
                ...
                <div class=" pull-right">
                    ...
                    <a href="" class="btn btn-default disabled" role="button">
                        ...
                        <span class="glyphicon glyphicon-file"></span> Fiche Médicale
                    ...
                    <a href="{{ route('student.edit', $student->id) }}" class="btn btn-primary" role="button">
                    ...
                    <a v-on:click.prevent="deleteForm($event)"
                       href="" class="btn btn-danger" role="button">
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button @click="submitEmergencyForm" type="button" class="btn btn-primary"> Ajouter </button>
